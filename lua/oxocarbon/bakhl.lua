...
local base06 = "#ffffff"
local base09 = "#78a9ff"
local oxocarbon = (((vim.o.background == "dark") and {base00 = base00, base01 = blend_hex(base00, base06, 0.085),
    base02 = blend_hex(base00, base06, 0.18), base03 = blend_hex(base00, base06, 0.3), base04 = "#bacaf9", base05 = blend_hex(base00, base06, 0.95),
    base06 = base06, base07 = "#08bdba", base08 = "#3ddbd9", base09 = base09, base10 = "#ee5396", base11 = "#33b1ff", base12 = "#ff8ff0",
    base13 = "#82cfff", base14 = "#be95ff", base15 = "#80fcc4", base16 = "#505684", base17 = "#ffab91", base18 = "#6d60b7", base19 = "#0f62fe",
    base20 = "#27273d", base21 = "#9da6f9", base22 = "#d68fff ", base23 = "#fe6279 ", base24 = "#8ff0ff", base25 = "#ffd68f", base26 = "#9e8fff",
    base27 = "#ff8fb8", base28 = "#8fffd6", base29 = "#8fb8ff", blend = "#131313", none = "NONE"})
    or {base00 = base06, base01 = blend_hex(base00, base06, 0.95), base02 = blend_hex(base00, base06, 0.82), base03 = base00, base04 = "#37474F",
    base05 = "#90A4AE", base06 = "#525252", base07 = "#08bdba", base08 = "#ff7eb6", base09 = "#ee5396", base10 = "#FF6F00", base11 = "#0f62fe",
    base12 = "#6d60b7", base13 = "#42be65", base14 = "#be95ff", base15 = "#ffab91", blend = "#FAFAFA", none = "NONE"})

-- base00 = "#161616", base04 = "#bacaf9", base06 = "#ffffff", base07 = "#08bdba", base08 = "#3ddbd9", base09 = "#78a9ff",
-- base10 = "#ee5396", base11 = "#33b1ff", base12 = "#ff8ff0", base13 = "#82cfff", base14 = "#be95ff", base15 = "#80fcc4",
...
vim.api.nvim_set_hl(0, "Directory", {fg = "#99eeff", bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "markdownBold", {fg = oxocarbon.base10, bg = oxocarbon.none, bold = true})
...
vim.api.nvim_set_hl(0, "markdownCodeBlock", {fg = oxocarbon.base04, bg = oxocarbon.base20})
...
vim.api.nvim_set_hl(0, "RenderMarkdownH2", {fg = oxocarbon.base15, bg = oxocarbon.base00}) -- base15 "#82cfff"
vim.api.nvim_set_hl(0, "RenderMarkdownH3", {fg = oxocarbon.base08, bg = oxocarbon.base00})
vim.api.nvim_set_hl(0, "RenderMarkdownH4", {fg = oxocarbon.base07, bg = oxocarbon.base00}) -- base07 #08bdba
...
vim.api.nvim_set_hl(0, "RenderMarkdownCode", {bg = oxocarbon.base00}) --"#ee5396", base11 = "#33b1ff", base12 = "#ff7eb6"
...
vim.api.nvim_set_hl(0, "RenderMarkdownTableRow", {fg = oxocarbon.base14}) -- base14 "#be95ff"
vim.api.nvim_set_hl(0, "RenderMarkdownQuote", {fg = oxocarbon.base21})
vim.api.nvim_set_hl(0, "RenderMarkdownInfo", {fg = oxocarbon.base09}) -- base09 "#78a9ff"
vim.api.nvim_set_hl(0, "RenderMarkdownHint", {fg = oxocarbon.base13}) -- base13 "#80fcc4"
vim.api.nvim_set_hl(0, "RenderMarkdownSuccess", {fg = oxocarbon.base08}) -- base08 "#3ddbd9"
vim.api.nvim_set_hl(0, "RenderMarkdownWarn", {fg = oxocarbon.base23})
vim.api.nvim_set_hl(0, "RenderMarkdownError", {fg = oxocarbon.base17})
vim.api.nvim_set_hl(0, "RenderMarkdownSubhead", {fg = oxocarbon.base22})
...
vim.api.nvim_set_hl(0, "MarkviewCode", {bg = oxocarbon.base20})
vim.api.nvim_set_hl(0, "MarkviewInfoCode", {fg = oxocarbon.base15, bg = oxocarbon.base20})
vim.api.nvim_set_hl(0, "MarkviewInlineCode", {fg = oxocarbon.base04, bg = oxocarbon.base20})
...
vim.api.nvim_set_hl(0, "MarkviewPalette0", {fg = oxocarbon.base04})
vim.api.nvim_set_hl(0, "MarkviewPalette0Fg", {fg = oxocarbon.base04})
vim.api.nvim_set_hl(0, "MarkviewPalette0Sign", {fg = oxocarbon.base16})
vim.api.nvim_set_hl(0, "MarkviewPalette1", {fg = oxocarbon.base22})
vim.api.nvim_set_hl(0, "MarkviewPalette1Sign", {fg = oxocarbon.base22})
vim.api.nvim_set_hl(0, "MarkviewPalette1Fg", {fg = oxocarbon.base22})
vim.api.nvim_set_hl(0, "MarkviewPalette2", {fg = oxocarbon.base29})
vim.api.nvim_set_hl(0, "MarkviewPalette2Sign", {fg = oxocarbon.base29})
vim.api.nvim_set_hl(0, "MarkviewPalette2Fg", {fg = oxocarbon.base29})
vim.api.nvim_set_hl(0, "MarkviewPalette3", {fg = oxocarbon.base28})
vim.api.nvim_set_hl(0, "MarkviewPalette3Sign", {fg = oxocarbon.base28})
vim.api.nvim_set_hl(0, "MarkviewPalette3Fg", {fg = oxocarbon.base28})
vim.api.nvim_set_hl(0, "MarkviewPalette4", {fg = oxocarbon.base23})
vim.api.nvim_set_hl(0, "MarkviewPalette4Sign", {fg = oxocarbon.base23})
vim.api.nvim_set_hl(0, "MarkviewPalette4Fg", {fg = oxocarbon.basse23})
vim.api.nvim_set_hl(0, "MarkviewPalette5", {fg = oxocarbon.base18})
vim.api.nvim_set_hl(0, "MarkviewPalette5Sign", {fg = oxocarbon.base18})
vim.api.nvim_set_hl(0, "MarkviewPalette5Fg", {fg = oxocarbon.base18})
vim.api.nvim_set_hl(0, "MarkviewPalette6", {fg = oxocarbon.base19})
vim.api.nvim_set_hl(0, "MarkviewPalette6Sign", {fg = oxocarbon.base19})
vim.api.nvim_set_hl(0, "MarkviewPalette6Fg", {fg = oxocarbon.base19})
vim.api.nvim_set_hl(0, "MarkviewBlockQuoteDefault", {fg = oxocarbon.base21})
vim.api.nvim_set_hl(0, "MarkviewBlockQuoteNote", {fg = oxocarbon.base09}) -- base09 "#78a9ff"
vim.api.nvim_set_hl(0, "MarkviewBlockQuoteOk", {fg = oxocarbon.base13}) -- base13 "#80fcc4"
vim.api.nvim_set_hl(0, "MarkviewBlockQuoteWarn", {fg = oxocarbon.base27})
vim.api.nvim_set_hl(0, "MarkviewBlockQuoteError", {fg = oxocarbon.base17})
vim.api.nvim_set_hl(0, "MarkviewBlockQuoteSpecial", {fg = oxocarbon.base08}) -- base08 "#3ddbd9"
vim.api.nvim_set_hl(0, "MarkviewBlockQuoteExtra", {fg = oxocarbon.base15})-- base15 = "#82cfff"
vim.api.nvim_set_hl(0, "MarkviewBlockQuoteSubhead", {fg = oxocarbon.base14})
vim.api.nvim_set_hl(0, "MarkviewBlockQuoteHead2", {fg = oxocarbon.base26})
vim.api.nvim_set_hl(0, "MarkviewBlockQuoteHead3", {fg = oxocarbon.base24})
vim.api.nvim_set_hl(0, "MarkviewListItemMinus", {fg = oxocarbon.base12}) -- 12 25
vim.api.nvim_set_hl(0, "MarkviewListItemStar", {fg = oxocarbon.base25})
vim.api.nvim_set_hl(0, "MarkviewTableHeader", {fg = oxocarbon.base21})  -- 21
vim.api.nvim_set_hl(0, "MarkviewTableBorder", {fg = oxocarbon.base21})
vim.api.nvim_set_hl(0, "MarkviewTableAlignLeft", {fg = oxocarbon.base21})
vim.api.nvim_set_hl(0, "MarkviewTableAlignRight", {fg = oxocarbon.base21})
vim.api.nvim_set_hl(0, "MarkviewTableAlignCenter", {fg = oxocarbon.base21})
...
--[[
vim.api.nvim_set_hl(0, "MarkviewGradient0", {fg = ""})
vim.api.nvim_set_hl(0, "MarkviewGradient1", {fg = ""})
vim.api.nvim_set_hl(0, "MarkviewGradient2", {fg = ""})
vim.api.nvim_set_hl(0, "MarkviewGradient3", {fg = ""})
vim.api.nvim_set_hl(0, "MarkviewGradient4", {fg = ""})
vim.api.nvim_set_hl(0, "MarkviewGradient5", {fg = ""})
vim.api.nvim_set_hl(0, "MarkviewGradient6", {fg = ""})
vim.api.nvim_set_hl(0, "MarkviewGradient7", {fg = ""})
vim.api.nvim_set_hl(0, "MarkviewGradient8", {fg = ""})
vim.api.nvim_set_hl(0, "MarkviewGradient9", {fg = ""})
]]--
-- MarkviewCheckbox[Cancelled / Pending / Progress / Striked]
-- Markview Icon0-6
-- Markview[Hyperlink / Image / Email / Subscript / Superscript]
...
vim.api.nvim_set_hl(0, "@text", {fg = "#bacaf9", bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@text.strong", {fg = oxocarbon.base11, bg = oxocarbon.none, bold = true})
vim.api.nvim_set_hl(0, "@text.emphasis", {fg = oxocarbon.base10, bg = oxocarbon.none, italic = true})
...
vim.api.nvim_set_hl(0, "@text.literal", {fg = "#bacaf9", bg = oxocarbon.none})
